...
public:
    ...
    virtual bool GetFreePoints(const TMTList<TG2DPoint>& PointList,TMTList<TG2DPoint>& FreePoint){throw EMyException("<TG2DLink::IsBestToUpdate>: Not implemented.");};
    virtual bool PointInLink(TG2DPoint* Point){throw EMyException("<TG2DLink::PointInLink>: Not implemented.");};

    virtual bool HaveLinked(const TMTList<TG2DPoint>& PointList,const TG2DPoint* Point){throw EMyException("<TG2DLink::HaveLinked>: Not implemented.");};
    virtual bool IsLinked(TG2DPoint* GPoint1,TG2DPoint* GPoint2){throw EMyException("<TG2DLink::IsLinked>: Not implemented.");};
