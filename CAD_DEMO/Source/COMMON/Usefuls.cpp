...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
// åñëè ïåðåäàåòñÿ 0  â _METAID òî èäåíòèôèêàòîðû ãåíåð. àâòîì.
// åñëè èìÿ óæå åñòü ê èìåíè äîáàâëÿåòñÿ 1,2,3,4,....
...
bool ClassCheck(const TMyObject* Object,const TClassNode* _Class)
{
    ...
    {
        AnsiString Str = "<ClassCheck>: àðãóìåíò-îáúåêò íå çàðåãèñòðèðîâàí.";
        throw EMyException(Str);
    }
