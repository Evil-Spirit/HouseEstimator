...
//    	ErrorMsg(AnsiString("<TFloatForm::GetParentDockIndex>: íå äîïóñòèìûé êëàññ ðîäèòåëÿ ïëàâàþùåé ôîðìû - <")+ClassParent+AnsiString(">."));
		return -1;
    }
    if ( !((TPanel*)aParent)->Parent )
    {
//    	ErrorMsg(AnsiString("<TFloatForm::GetParentDockIndex>: ðîäèòåëüñêàÿ ïàíåëü íå èìååò ðîäèòåëÿ."));
		return -1;
    }
    if ( !IS(((TPanel*)aParent)->Parent,__classid(TBaseDockSiteForm)) )
    {
    	AnsiString ClassParent = ((TPanel*)aParent)->Parent->ClassName();
//    	ErrorMsg(AnsiString("<TFloatForm::GetParentDockIndex>: íå äîïóñòèìûé êëàññ dock-site ôîðìû - <")+ClassParent+AnsiString(">.") );
		return -1;
    }
