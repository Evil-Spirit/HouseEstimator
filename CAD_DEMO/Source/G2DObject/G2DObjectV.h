...
public:
    ...
    static TMyObject* CreateFunction();
	TGeomFlags FFlags;
    virtual bool UpdatePointRule(TG2DPoint* GPoint){throw EMyException("<TG2DLink::IsBestToUpdate>: Íåðåàëèçîâàíî.");};
    virtual bool IsBestToUpdate(TG2DPoint* GPoint){throw EMyException("<TG2DLink::IsBestToUpdate>: Íåðåàëèçîâàíî.");};
    virtual bool GetFreePoints(const TMTList<TG2DPoint>& PointList,TMTList<TG2DPoint>& FreePoint){throw EMyException("<TG2DLink::IsBestToUpdate>: Íåðåàëèçîâàíî.");};
    virtual bool PointInLink(TG2DPoint* Point){throw EMyException("<TG2DLink::PointInLink>: Íåðåàëèçîâàíî.");};

    virtual bool HaveLinked(const TMTList<TG2DPoint>& PointList,const TG2DPoint* Point){throw EMyException("<TG2DLink::HaveLinked>: Íåðåàëèçîâàíî.");};
    virtual bool IsLinked(TG2DPoint* GPoint1,TG2DPoint* GPoint2){throw EMyException("<TG2DLink::IsLinked>: Íåðåàëèçîâàíî.");};
	...
	virtual bool CanUpdateList(TMTList<TG2DPoint>& PointList){throw EMyException("<TG2DLink::CanUpdateList>: Íåðåàëèçîâàíî.");};
};
