...
void __fastcall TDbgInspector::ShowProperty(AnsiString Name,TMDelTList<TLuaVariable> *Vars)
{
    ...
    if (Vars->Count>0)
    {
        ...
        DataWatch1->Rows[0]->BeginUpdate();
        DataWatch1->Rows[1]->BeginUpdate();
        DataWatch1->Rows[2]->BeginUpdate();
        ...
        DataWatch1->Rows[0]->EndUpdate();
        DataWatch1->Rows[1]->EndUpdate();
        DataWatch1->Rows[2]->EndUpdate();
    ...
    if ((myHeight>(this->ClientHeight-dH))&&(myHeight+dH+dH1<450))
    {
