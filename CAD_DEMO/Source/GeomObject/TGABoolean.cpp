...
public:
	...
	TIntVec		Point;	//ãåîì. òî÷êà

	TGCut		*Cut;   //ïàðà
	TGPolygon	*Poly;

	TGPoint 	*Target;	//èñêîìàÿ òî÷êà 
	...
	TGIntPoint(const TGIntPoint &point) //êîïèðîâàíèå
	{
		Target	= point.Target;
		Poly	= point.Poly;
		Cut		= point.Cut;
	...
	TGIntPoint(const TIntVec &point, TGCut *cut, TGPolygon *poly) //ñîçäàíèå
	{
		Target	= NULL;
		Poly	= poly;
		Cut		= cut;
...
//	result.UnRegisterCutPointers(&sCuts);
	//ðàíüøå used îçíà÷àë òî÷êà êàñàåòñÿ îòðåçêîâ ðàññå÷åíèÿ
	//used òåïåðü èìååò ñìûñë "mark"
