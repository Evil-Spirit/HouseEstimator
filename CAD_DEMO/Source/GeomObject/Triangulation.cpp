...
bool TDelone::FindDeloneBrother(int i1,int i2)
{
    ...
    if (_max != 1)
    {
        bool f = FindDeloneBrother(i1, iN); //-= çàïóñòèì 2 íîâûå áàçîâûå ëèíèè
...
bool TDelone::FindDeloneBrother_Ribs(int i1,int i2)
{
    ...
    if (_max != 1)
    {
        bool f = FindDeloneBrother_Ribs(i1, iN); //-= çàïóñòèì 2 íîâûå áàçîâûå ëèíèè
