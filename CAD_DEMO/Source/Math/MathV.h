...
const int PL_CROSS_PARALLEL     = 0; // ïðÿìàÿ è ïëîñêîñòü ïàðàëëåëüíû
const int PL_CROSS_ONEPOINT     = 1; // îäíà òî÷êà
const int PL_CROSS_CONSISTS     = 2; // ïðÿìàÿ ïðèíàäëåæèò ïëîñêîñòè
const int PL_CROSS_OUTOFBORDER  = 3; // òî÷êà ïðåñå÷åíèÿ íå ëåæèò íà ëó÷å

//âñïîìîãàòåëüíûå

//øàã ñèñòåìû âî ôëîàòå
...
/******************************************************************************************/
COMMONAL_API int PlaneLineCross(	const TIntVec& N,	//íîðìàëü
...
COMMONAL_API int PlaneCutCross(	const TIntVec& N,	//íîðìàëü
									const TIntVec& A,	//òî÷êà íà ïëîñêîñòè
									const TIntVec& X,	//ïðÿìàÿ òî÷êà 1
									const TIntVec& Y,	//ïðÿìàÿ òî÷êà 2
									TIntVec& O, 		//òî÷êà ïåðåñå÷åíèÿ
...
COMMONAL_API int PlaneSegmentCross(	const	TIntVec& N,	//íîðìàëü
									const	TIntVec& A,	//òî÷êà íà ïëîñêîñòè
									...
									bool	yFix,		//ïîïàäàíèå êîíöà
			
									TIntVec& O, 		//òî÷êà ïåðåñå÷åíèÿ
						
									MBTi USEEPS);    	// Epsilon

COMMONAL_API int  PlaneCutCrossClass(	const TIntVec& N,//òî÷êà íà ïëîñêîñòè
...
COMMONAL_API bool PlaneCrossPoint(   const TIntVec& A,//òî÷êà íà ïëîñêîñòè
						const TIntVec& PlaneN,//íîðìàëü
						const TIntVec& X,
						const TIntVec& Y,
						TIntVec& O);
