...
{// Çàïîëíèòü îêðóæàþùèå ÿ÷åéêè áîðäþðàì èç òåêóùåé
    // Ñóùåñòâóþò
    if (GetCellSimple(Col, Row) !=NULL)
    {
        ...
        throw EMyException("<TCellGrid::SetÑircumferentialBorder>: íå äîïóñòèìîå ïðèìåíåíèå äàííîé ôóíêöèè");
...
{// Çàïîëíèòü îêðóæàþùèå ÿ÷åéêè áîðäþðàì ïî òåêóùèì ïàðàìåòðàì
    // Ñóùåñòâóþò
    int aCol;
    int aRow;
    bool bError =false;
    ...
    {
        bError =true;
        throw EMyException("<TCellGrid::SetCircumferentialBorderCol>: Íå äîïóñòèìîå ïîëîæåíèå");
    }
...
{// Çàïîëíèòü îêðóæàþùèå ÿ÷åéêè áîðäþðàì ïî òåêóùèì ïàðàìåòðàì
    ...
    {
        bError =true;
        throw EMyException("<TCellGrid::SetCircumferentialBorderRow>: Íå äîïóñòèìîå ïîëîæåíèå");
    }
...
{// ßâëÿåòüñÿ ëè ýòà ÿ÷åéêà ïðîñòîé èëè Union íî îòëè÷íîé îò íèæíåãî Union
    bool ret=false;
    if (Row-1 <0)
    {
        ret=true;
