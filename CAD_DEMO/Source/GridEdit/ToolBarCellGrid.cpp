...
//    Height =24;
    ...
    // Îòîáðàæåíèå íóìåðîâàíûõ (ñòðîê, ñòîëáöîâ)
...
{ // Óñòàíîâèòü íàæàòèå èêîíîê ToolBar â ñîîòâåòñòâèè ñ âûäåëåííîé îáëàñòüþ
    if (CellGrid1 !=NULL &&
        ...
        )
    {
        ...
        //--- Ïîëó÷åíèå ïàðàìåòðîâ ïåðâîé ÿ÷åéêè
        ...
        //------- Öèêë ïðîâåðêè ñ îñòàëüíûìè ÿ÷åéêàìè
        TCell* Cell;
        for (int i=0; i<End; i++)
        {
        ...
        //--- Óñòàíîâêà ñîîòâåòñòâóþùåãî ïîëîæåíèÿ
