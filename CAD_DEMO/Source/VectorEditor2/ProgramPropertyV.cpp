...
void __fastcall TProgramProperty::bOkClick(TObject *Sender)
{
    ...
    Editor2D->View->BackgroundColor = ProgramProperty->cbBackGround->Selected;
    Editor2D->View->Color = ProgramProperty->cbBackGround->Selected;
