...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TPictureEditorF(Classes::TComponent* AOwner) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TPictureEditorF(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TPictureEditorF(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TPictureEditorF(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	#pragma option pop
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE TPictureEditorF* PictureEditorF;
