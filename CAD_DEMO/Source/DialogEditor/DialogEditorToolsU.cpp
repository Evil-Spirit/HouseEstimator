...
TCreateTool::TCreateTool(int _ClassId)
{
    ImageId = _ClassId-1;
    ClassId = _ClassId;
    AddStateBlock(ctState1_WaitingMouseDown, WaitingMouseDown, Mouse_Move, btNone, "Îæèäàíèå íàæàòèÿ êëàâèøè äëÿ îïðåäåëåíèÿ ìåñòà äëÿ ñîçäàíèÿ íîâîãî îáúåêòà íà ôîðìå.");
    AddStateBlock(ctState2_SelectBorderFrame, SelectBorderFrame, Mouse_Move, btNone, "Âûáîð ãðàíèö îáúåêòà.");
    AddActionBlock(ctAction1_GetCoords, GetCoords, btNone, "Îïðåäåëåíèå íà÷àëüíûõ êîîðäèíàò.");
    AddActionBlock(ctAction2_CreateObject, CreateObject, btMenu, "Ñîçäàíèå îáúåêòà: Ñîçäàíèå TVCLEditorElement, âëþ÷àþùåãî ñîçäàíèå TComponent è ñîîòâåòñòâóþùåé åìó ôîðìû (äëÿ íå ÿâëÿþùèõñÿ TWinControl). Äîáàâëåíèå îáúåêòà â ObjectTree è â ObjectInspector.");
...
TSelectTool::TSelectTool(int _ClassId)
{
    ...
    //State: (Add Block)
    //-----------------------------------------------------------------------
    AddStateBlock(stState1_WaitingFirstAction, WaitingFirstAction, Mouse_Move, btNone, "Îæèäàíèå êëèêà ìûøè, èëè íàæàòèÿ êëàâèøè.");
    AddStateBlock(stState2_WaitingMouseUpClickForSelect, WaitingMouseUpClickForSelect, Mouse_Move, btMenu, "Âûäåëåíèå: Îæèäàíèå 'MouseUp', ÷òîáû ñôîðìèðîâàòü ãðàíèöû âûäåëåíèÿ.");
    AddStateBlock(stState3_DragControls, DragControls, Mouse_Move, btMenu, "Ïåðåòàñêèâàíèå: ïåðåòàñêèâàíèå ñîçäàííûõ îáúåêòîâ íà ôîðìå ïîêà íå 'MouseUp'.");
    AddStateBlock(stState4_WaitingMouseUpClickForReSize, WaitingMouseUpClickForReSize, Mouse_Move, btMenu, "Èçìåíåíèå ðàçìåðà: Îæèäàíèå 'MouseUp', ÷òîáû ñâîðìèðîâàòü íîâûå ãðàíèöû îáúåêòà.");
    //Condition: (Add Block)
    //-----------------------------------------------------------------------
    AddConditionalBlock(stCondition1_IfShiftPressed, IfShiftPressed, btNone, "Ïðîâåðêà íà íàæàòèå êëàâèøè 'Shift'.");
    AddConditionalBlock(stCondition2_IfMouseOnBorder, IfMouseOnBorder, btNone, "Ïðîâåðêà ïîçèöèè ìûøè íà ãðàíèöå îáúåêòà, äëÿ îïðåäåëåíèÿ: Èçìåíåíèå ðàçìåðà, èëè Ïåðåòàñêèâàíèå.");
    AddConditionalBlock(stCondition3_IfMouseOnControl, IfMouseOnControl, btNone, "Ïðîâåðêà ïîçèöèè ìûøè íà îáúåêòå, äëÿ îïðåäåëåíèÿ: Âûäåëåíèå, èëè Ïåðåòàñêèâàíèå.");
    AddConditionalBlock(stCondition4_IfShiftOnControl, IfShiftOnControl, btNone, "Ïðîâåðêà íà íàæàòèå êëàâèøè 'Shift' ïðè ïîçèöèè ìûøè 'Íà îáúåêòå'.");
    AddConditionalBlock(stCondition5_IfShiftOnSelection, IfShiftOnSelection, btNone, "Ïðîâåðêà íà íàæàòèå êëàâèøè 'Shift' ïðè ïîçèöèè ìûøè 'Íà âûäåëåíèè'.");
    //Active: (Add Block)
    //-----------------------------------------------------------------------
    AddActionBlock(stActive_SelectClickControl, SelectClickControl, btNone, "Îïðåäåëåíèå Control'à ïî êëèêó.");
    AddActionBlock(stActiveStart_StartTool, StartTool, btNone, "Î÷èñòêà ýêðàíà, ïåðåðèñîâêà Grid íà íîâîì öèêëå äåéñòâèÿ SelectTool.");
    AddActionBlock(stActive2_ReactionOnButtonClick, ReactionOnButtonClick, btMenu, "KeyPressed: Îïðåäåëåíèå íàæàòèÿ êëàâèø 'Ctrl', 'Shift', èëè 'Delete' äëÿ âûáîðà ñîîòâåòñâóþùåãî äåéñòâèÿ. Èñïîëíåíèå âûáðàííîãî äåéñòâèÿ.");
    AddActionBlock(stActive3_SelectControls, SelectControls, btNone, "Âûáîð âûäåëåííûõ îáúåêòîâ - äîáàâëåíèå èõ â ñîîòâåòñòâóþùèå ñïèñêè âûäåëåíèÿ.");
    AddActionBlock(stActive4_DeleteControlFromList, DeleteControlFromList, btNone, "Óäàëåíèå îáúåêòà èç ñïèñêîâ âûäåëåíèÿ.");
    AddActionBlock(stActive5_InsertControlToList, InsertControlToList, btNone, "Äîáàâëåíèå îáúåêòà â ñïèñêè âûäåëåíèÿ.");
    //State: (Go to Block)
    //-----------------------------------------------------------------------
