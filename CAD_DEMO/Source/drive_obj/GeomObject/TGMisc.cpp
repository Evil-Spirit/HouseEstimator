...
TCrossResult PlaneSegmentCross(	const	TIntVec& N,	//íîðìàëü
...
TCrossResult PlaneLineCross(	const TIntVec& N,	//íîðìàëü
								const TIntVec& A,	//òî÷êà íà ïëîñêîñòè
								const TIntVec& X,	//ïðÿìàÿ òî÷êà 1
								const TIntVec& Y,	//ïðÿìàÿ òî÷êà 2
								TIntVec& O, 		//òî÷êà ïåðåñå÷åíèÿ
...
// îòëàæåíî
TGeoClassify PlaneCutCrossClass(	const TIntVec& A,//òî÷êà íà ïëîñêîñòè
