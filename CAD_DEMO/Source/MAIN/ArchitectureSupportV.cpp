...
/*    if (!FirstPlatform)
    {
        Application->MessageBox("Standart First TPlatform íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!DefaultLand)
    {
        Application->MessageBox("DefaultLand íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!MetaLabel3D)
    {
        Application->MessageBox("Standart MetaLabel3D íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!MetaLabelLink)
    {
        Application->MessageBox("Standart MetaLabelLink íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!Platform_Land)
    {
        Application->MessageBox("Standart Platform_Land_Link íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!DEFAULT_SIZE)
    {
        Application->MessageBox("Standart DEFAULT_SIZE íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!DEFAULT_MODE)
    {
        Application->MessageBox("Standart DEFAULT_MODE íå íàéäåí","Error");
        inited = false;
        return;
    }
    if (!_3D_MODE)
    {
        Application->MessageBox("Standart _3D_MODE íå íàéäåí","Error");
        inited = false;
        return;
    }
